...
public class ARDrawLine : MonoBehaviour
{
    ...
    private CameraPositonText cameraPo;
    ...
    public void MakeLineRendere()
    {
        ...
        cameraPo = textManager.GetComponent<CameraPositonText>();
        cameraPo.lineObj = tLine;
